...
function saveGameState()
    ...
    -- Konwersja kolorów do formatu serializowalnego
...
function loadGameState()
    ...
    -- Wczytaj zawartość zapisanego stanu gry
    ...
    -- Spróbuj uruchomić wczytany kod Lua
    ...
    -- Wywołaj funkcję, aby uzyskać stan gry
    ...
    -- Sprawdź, czy wynik jest poprawną tabelą
